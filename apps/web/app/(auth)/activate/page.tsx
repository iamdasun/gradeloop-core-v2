    ...
    <div className="w-full max-w-md animate-in fade-in zoom-in duration-500">
      <Card className="border-none shadow-2xl shadow-indigo-200/50 dark:shadow-none bg-white/80 dark:bg-zinc-950/80 backdrop-blur-xl transition-all duration-500">
        ...
        {state.status === "no-token" && (
          <>
            <CardHeader className="space-y-4 pb-8 text-center ring-offset-background">
        ...
        {state.status === "ready" && (
          <>
            <CardHeader className="space-y-4 pb-8 text-center">
              <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-3xl bg-primary text-primary-foreground shadow-xl shadow-primary/20 rotate-3 transition-transform hover:rotate-0">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3 rounded-2xl border border-primary/10 bg-primary/5 p-5">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-foreground/80 font-medium">Verify your email & activate</p>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-foreground/80 font-medium">Receive temporary password</p>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-foreground/80 font-medium">Login and set your secure password</p>
                </div>
              </div>
            </CardContent>
        ...
        {state.status === "activating" && (
          <CardContent className="py-20 flex flex-col items-center justify-center gap-6">
