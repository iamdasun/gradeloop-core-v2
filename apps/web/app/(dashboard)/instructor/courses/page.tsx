      ...
      <div className="flex gap-3 rounded-xl border border-blue-200 dark:border-blue-900/50 bg-blue-50 dark:bg-blue-950/30 p-4">
        ...
        <div>
          ...
          <p className="text-xs text-blue-700 dark:text-blue-400 mt-0.5">
            As an instructor, you can view the instances you are assigned to and
            manage student submissions. Full course metadata is restricted to
            administrators.
          </p>
        </div>
      </div>
          ...
          {courses.map((course) => (
            ...
            >
              <CardContent className="p-6 flex flex-col gap-4 flex-1">
                ...
                >
                  <Link
                    href={`/instructor/courses/${course.course_instance_id}`}
                  >
                    View Details
