...
This module implements the tiered detection strategy:
...
class TieredPipeline:
    ...
    1. Type-1: Literal comparison with high threshold
    2. Type-2: Blinded comparison with medium threshold
    ...
    def __init__(
        ...
        Args:
            ...
            classifier: Pre-trained Random Forest classifier
        """
    ...
    def detect(
        ...
        """
        Run tiered detection on two code snippets.
        ...
        # Check if Type-1 or Type-2 was detected
        if result.clone_type in ["Type-1", "Type-2"]:
            return result

        # Phase Two: TOMA Approach for Type-3
        return self._phase_two_toma(code1, code2, language, abstract_identifiers)
...
def get_tiered_pipeline(
    ...
    Args:
        classifier: Optional pre-trained classifier
