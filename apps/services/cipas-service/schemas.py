...
class ComparisonRequest(BaseModel):
    ...
    pipeline: PipelineEnum = Field(
        default=PipelineEnum.BOTH,
        description="Which pipeline to use for comparison",
    )
